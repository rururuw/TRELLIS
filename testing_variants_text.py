...
def run_test_single_attribute(from_scratch: bool = True, tag: str = '', mesh_file_name: str = 'temp_mesh.ply'):
    ...
    init_prompt = 'A round wooden accent table'
...
if __name__ == "__main__":
    # run_test(False)
    # run_test_single_attribute(True, 'uncond_neutral_pn_slider_delta', 'combo_small.ply')
    span = 5
    spacing = 1
    run_test_single_attribute_image(False, 'uncond_neutral_pn_slider_{}_{}'.format(span, spacing), span, spacing, 'assets/example_sofa/a_blue_sofa.ply')